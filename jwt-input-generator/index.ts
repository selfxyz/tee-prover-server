...
const MAX_EAT_NONCE_B64_LENGTH = 99;
const MAX_IMAGE_DIGEST_LENGTH = 71;
...
async function main() {
  ...
  try {
    ...
    console.log('[INFO] Raw JWT:', rawJWT);
    ...
    console.log('[INFO] Loaded raw JWT from the TEE socket');
    ...
    // Find value offset: position of the actual value
    const imageDigestValueOffset = payloadJSON.lastIndexOf(imageDigest);
